...
<html>
<head>
<title>BB <3 Android. Quelles applications Android sont compatbile avec mon Blackberry ?</title>
<meta name="description" description="Site testant les applications Android sur Blacberry afin de savoir si celle-ci sont compatbiles" />
<meta name="keywords" content="Blackberry,BB10,Blackberry 10,Android,Z10,Q10,Q5,Compatible,RIM" />
...
<!--     Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="#AppList" class="AppList" id="AppList" name="AppList" rel="follow">Applications</a></li>
        <li><a href="#Tuto" class="Tuto" id="Tuto" name="Tuto" rel="follow">Tutoriel</a></li>
        <li><a href="#Propos" class="Propos" id="Propos" name="Propos" rel="follow">A propos</a></li>
      </ul>
...
<br />
  ...
  <center><b>BB <span class="glyphicon glyphicon-heart"></span><b> Android, comment ça marche ?</b><br />
